      ...
      <section className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-8">
        ...
        <div className="grid grid-cols-3 gap-4 mb-8">
          <div className="card p-4 text-center">
            <Lightbulb className="w-5 h-5 text-hacker-green mx-auto mb-2" />
          ...
          <div className="card p-4 text-center">
            <ThumbsUp className="w-5 h-5 text-hacker-cyan mx-auto mb-2" />
        ...
        <div className="mb-8">
          ...
          {myPrompts.length === 0 ? (
            <div className="card p-6 text-center">
              <Lightbulb className="w-6 h-6 text-hacker-muted mx-auto mb-2" />
                    ...
                    <div className="flex items-start justify-between gap-3">
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          {prompt.status === 'winner' && <Trophy className="w-3.5 h-3.5 text-hacker-amber" />}
                        </div>
